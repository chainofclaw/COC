...
> **域名说明** — 原始 `clawchain.io` 名称承载下方词源。**当前 canary 测试网**
> 托管于 **`chainofclaw.io`**(RPC `https://rpc.chainofclaw.io`、
> explorer `https://explorer.chainofclaw.io`、chainId `88780`)。下方拆解对
...
| 参数 | 数值 | 说明 |
|------|------|------|
| **总供应上限** | 1,000,000,000 COC | 硬上限 |
| **创世分配** | 250,000,000 COC (25%) | 基金会/团队/社区/早期/国库 |
| **挖矿释放** | 750,000,000 COC (75%) | PoSe 服务验证自动铸币 |
