...
export const CocBackupConfigSchema = z.object({
  ...
  contractAddress: z.string().describe("SoulRegistry contract address"),
  privateKey: z.string().describe("Ethereum private key for signing"),
  ...
  maxIncrementalChain: z.number().default(10).describe("Max incremental backups before forcing full backup"),
